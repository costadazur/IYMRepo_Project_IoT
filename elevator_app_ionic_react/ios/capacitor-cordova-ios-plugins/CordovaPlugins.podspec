  ...
  Pod::Spec.new do |s|
    ...
    s.source = { :git => 'https://github.com/ionic-team/does-not-exist.git', :tag => '2.4.2' }
    ...
    s.swift_version  = '5.0'
    s.frameworks = 'CoreBluetooth', 'UserNotifications', 'CoreLocation', 'AVFoundation', 'AudioToolbox'
  end