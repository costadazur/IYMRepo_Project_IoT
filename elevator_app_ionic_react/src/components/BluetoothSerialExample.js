...
class BluetoothSerialExample extends Component {
  ...
  componentWillMount () {
    ...
    this.bluetooth.on('bluetoothEnabled', () => Toast.showShortBottom('Bluetooth enabled'))
    this.bluetooth.on('bluetoothDisabled', () => Toast.showShortBottom('Bluetooth disabled'))
