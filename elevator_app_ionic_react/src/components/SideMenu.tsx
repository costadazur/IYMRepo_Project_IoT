...
class SideMenu extends React.Component<any, any> {
    ...
    this.state = {      
      ...
      routes:  {
        appPages: [
          ...
          { title: 'Send Feedback', path: '/sendfeedbackform', icon: 'home' },
        ],
        loggedInPages: [
          ...
          { title: 'Logout', path: '/loginredirect', icon: 'log-out' }
        ],
        loggedOutPages: [
          { title: 'Login', path: '/loginredirect', icon: 'log-in' },
        ]  }
    }
   ...
   renderMenuItem(menu: any) {
    return (
         <IonMenuToggle key={menu.title} auto-hide="false">
                   <IonItem>
                     <IonIcon name={menu.icon} slot="start"></IonIcon>
  ...
  render() {
      return (  
        <IonMenu type="reveal" side="start" menuId="first" contentId="main-content">
          <IonHeader>
            <IonToolbar color="success">
              <IonTitle id="side_menu_title">Start Menu</IonTitle>
            </IonToolbar>
          </IonHeader>
          <IonContent>
            <IonList>
